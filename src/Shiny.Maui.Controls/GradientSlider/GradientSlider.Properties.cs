...
public partial class GradientSlider
{
    ...
    public static readonly BindableProperty ValueProperty = BindableProperty.Create(
        nameof(Value), typeof(double), typeof(GradientSlider), 0.0,
        BindingMode.TwoWay,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    public double Value { get => (double)GetValue(ValueProperty); set => SetValue(ValueProperty, value); }

    // Minimum
    public static readonly BindableProperty MinimumProperty = BindableProperty.Create(
        nameof(Minimum), typeof(double), typeof(GradientSlider), 0.0,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    public double Minimum { get => (double)GetValue(MinimumProperty); set => SetValue(MinimumProperty, value); }

    // Maximum
    public static readonly BindableProperty MaximumProperty = BindableProperty.Create(
        nameof(Maximum), typeof(double), typeof(GradientSlider), 100.0,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    public double Maximum { get => (double)GetValue(MaximumProperty); set => SetValue(MaximumProperty, value); }

    // Step
    public static readonly BindableProperty StepProperty = BindableProperty.Create(
        nameof(Step), typeof(double), typeof(GradientSlider), 1.0);
    public double Step { get => (double)GetValue(StepProperty); set => SetValue(StepProperty, value); }

    // ColdColor
    public static readonly BindableProperty ColdColorProperty = BindableProperty.Create(
        nameof(ColdColor), typeof(Color), typeof(GradientSlider), Color.FromArgb("#3B82F6"),
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty HotColorProperty = BindableProperty.Create(
        nameof(HotColor), typeof(Color), typeof(GradientSlider), Color.FromArgb("#EF4444"),
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty TrackHeightProperty = BindableProperty.Create(
        nameof(TrackHeight), typeof(double), typeof(GradientSlider), 8.0,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty ThumbSizeProperty = BindableProperty.Create(
        nameof(ThumbSize), typeof(double), typeof(GradientSlider), 24.0,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty ThumbColorProperty = BindableProperty.Create(
        nameof(ThumbColor), typeof(Color), typeof(GradientSlider), Colors.White,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty ThumbBorderWidthProperty = BindableProperty.Create(
        nameof(ThumbBorderWidth), typeof(double), typeof(GradientSlider), 2.0,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty ShowTooltipProperty = BindableProperty.Create(
        nameof(ShowTooltip), typeof(bool), typeof(GradientSlider), true,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty TooltipBackgroundColorProperty = BindableProperty.Create(
        nameof(TooltipBackgroundColor), typeof(Color), typeof(GradientSlider), Color.FromArgb("#1F2937"),
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty TooltipTextColorProperty = BindableProperty.Create(
        nameof(TooltipTextColor), typeof(Color), typeof(GradientSlider), Colors.White,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty TooltipFontSizeProperty = BindableProperty.Create(
        nameof(TooltipFontSize), typeof(double), typeof(GradientSlider), 12.0,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty ValueFormatProperty = BindableProperty.Create(
        nameof(ValueFormat), typeof(string), typeof(GradientSlider), null);
    ...
    public static readonly BindableProperty TooltipTemplateProperty = BindableProperty.Create(
        nameof(TooltipTemplate), typeof(DataTemplate), typeof(GradientSlider), null,
        propertyChanged: (b, _, _) => ((GradientSlider)b).UpdateVisuals());
    ...
    public static readonly BindableProperty ValueChangedCommandProperty = BindableProperty.Create(
        nameof(ValueChangedCommand), typeof(ICommand), typeof(GradientSlider));
